  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center px-8 overflow-hidden">
      ...
      <div className="relative z-20 text-center max-w-4xl mx-auto float">
        ...
        <button className="group relative px-8 py-4 text-xl font-mono text-white bg-transparent border-2 border-red-400 rounded-lg overflow-hidden transition-all duration-300 hover:text-black">
